...
<div class="panel panel-success">
  ...
  <div class="form-group">
    	...
    	<div class="col-sm-3">
      		<input class="form-control input-sm"  type="text"  name="Res_card" placeholder="เลขบัตรประจำตัวประชาชน " maxlength="13" id="mynumber" onKeyUp="IsNumeric1(this.value,this)" />
